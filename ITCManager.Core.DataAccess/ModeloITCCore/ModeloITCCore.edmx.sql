...
-- --------------------------------------------------
-- Date Created: 04/10/2016 23:09:27
...
GO
IF OBJECT_ID(N'[dbo].[FK_CompraCompraCheque]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CompraChequeSet] DROP CONSTRAINT [FK_CompraCompraCheque];
GO
IF OBJECT_ID(N'[dbo].[FK_ChequeCompraCheque]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CompraChequeSet] DROP CONSTRAINT [FK_ChequeCompraCheque];
GO
...
IF OBJECT_ID(N'[dbo].[FK_TarjetaPropiaCompraTarjeta]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CompraTarjetaSet] DROP CONSTRAINT [FK_TarjetaPropiaCompraTarjeta];
GO
IF OBJECT_ID(N'[dbo].[FK_CompraCompraTarjeta]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CompraTarjetaSet] DROP CONSTRAINT [FK_CompraCompraTarjeta];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_CompraCompraChequePropio]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CompraChequePropioSet] DROP CONSTRAINT [FK_CompraCompraChequePropio];
GO
IF OBJECT_ID(N'[dbo].[FK_ChequePropioCompraChequePropio]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CompraChequePropioSet] DROP CONSTRAINT [FK_ChequePropioCompraChequePropio];
GO
...
GO
IF OBJECT_ID(N'[dbo].[CompraChequeSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CompraChequeSet];
GO
...
GO
IF OBJECT_ID(N'[dbo].[CompraTarjetaSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CompraTarjetaSet];
GO
...
GO
IF OBJECT_ID(N'[dbo].[CompraChequePropioSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CompraChequePropioSet];
GO
...
CREATE TABLE [dbo].[RendicionPagoSet] (
    ...
    [IdRendicionPersonaCiudad] int  NOT NULL,
    [IdPago] int  NOT NULL
);
GO
...
-- Creating table 'CompraPagoLocalSet'
CREATE TABLE [dbo].[CompraPagoLocalSet] (
    [IdCompraPagoLocal] int IDENTITY(1,1) NOT NULL,
    [IdCompra] int  NOT NULL,
    [IdPagoLocal] int  NOT NULL
);
GO
...
-- Creating table 'GastoLocalPagoLocalSet'
CREATE TABLE [dbo].[GastoLocalPagoLocalSet] (
    [IdGastoLocalPagoLocal] int IDENTITY(1,1) NOT NULL,
    [IdGastoLocal] int  NOT NULL,
    [IdPagoLocal] int  NOT NULL
);
GO
...
-- Creating primary key on [IdCompraPagoLocal] in table 'CompraPagoLocalSet'
ALTER TABLE [dbo].[CompraPagoLocalSet]
ADD CONSTRAINT [PK_CompraPagoLocalSet]
    PRIMARY KEY CLUSTERED ([IdCompraPagoLocal] ASC);
GO
...
-- Creating primary key on [IdGastoLocalPagoLocal] in table 'GastoLocalPagoLocalSet'
ALTER TABLE [dbo].[GastoLocalPagoLocalSet]
ADD CONSTRAINT [PK_GastoLocalPagoLocalSet]
    PRIMARY KEY CLUSTERED ([IdGastoLocalPagoLocal] ASC);
GO
...
-- Creating foreign key on [IdRendicionPersonaCiudad] in table 'RendicionPagoSet'
ALTER TABLE [dbo].[RendicionPagoSet]
ADD CONSTRAINT [FK_RendicionPersonaCiudadRendicionPago]
    FOREIGN KEY ([IdRendicionPersonaCiudad])
    REFERENCES [dbo].[RendicionPersonaCiudadSet]
        ([IdRendicionPersonaCiudad])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
...
-- Creating foreign key on [IdRendicionPersonaCiudad] in table 'RendicionGastoSet'
ALTER TABLE [dbo].[RendicionGastoSet]
...
-- Creating foreign key on [IdRendicionPersonaCiudad] in table 'RendicionDepositoSet'
ALTER TABLE [dbo].[RendicionDepositoSet]
...
-- Creating foreign key on [IdCompra] in table 'CompraPagoLocalSet'
ALTER TABLE [dbo].[CompraPagoLocalSet]
ADD CONSTRAINT [FK_CompraCompraPagoLocal]
    FOREIGN KEY ([IdCompra])
    REFERENCES [dbo].[CompraSet]
        ([IdCompra])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_CompraCompraPagoLocal'
CREATE INDEX [IX_FK_CompraCompraPagoLocal]
ON [dbo].[CompraPagoLocalSet]
    ([IdCompra]);
GO

-- Creating foreign key on [IdPagoLocal] in table 'CompraPagoLocalSet'
ALTER TABLE [dbo].[CompraPagoLocalSet]
ADD CONSTRAINT [FK_PagoLocalCompraPagoLocal]
    FOREIGN KEY ([IdPagoLocal])
    REFERENCES [dbo].[PagoLocalSet]
        ([IdPagoLocal])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_PagoLocalCompraPagoLocal'
CREATE INDEX [IX_FK_PagoLocalCompraPagoLocal]
ON [dbo].[CompraPagoLocalSet]
    ([IdPagoLocal]);
GO

-- Creating foreign key on [IdGastoLocal] in table 'GastoLocalPagoLocalSet'
ALTER TABLE [dbo].[GastoLocalPagoLocalSet]
ADD CONSTRAINT [FK_GastoLocalGastoLocalPagoLocal]
    FOREIGN KEY ([IdGastoLocal])
    REFERENCES [dbo].[GastoLocalSet]
        ([IdGastoLocal])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating non-clustered index for FOREIGN KEY 'FK_GastoLocalGastoLocalPagoLocal'
CREATE INDEX [IX_FK_GastoLocalGastoLocalPagoLocal]
ON [dbo].[GastoLocalPagoLocalSet]
    ([IdGastoLocal]);
GO

-- Creating foreign key on [IdPagoLocal] in table 'GastoLocalPagoLocalSet'
ALTER TABLE [dbo].[GastoLocalPagoLocalSet]
ADD CONSTRAINT [FK_PagoLocalGastoLocalPagoLocal]
    FOREIGN KEY ([IdPagoLocal])
    REFERENCES [dbo].[PagoLocalSet]
        ([IdPagoLocal])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_PagoLocalGastoLocalPagoLocal'
CREATE INDEX [IX_FK_PagoLocalGastoLocalPagoLocal]
ON [dbo].[GastoLocalPagoLocalSet]
    ([IdPagoLocal]);
GO
